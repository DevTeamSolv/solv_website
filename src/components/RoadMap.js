                ...
                <div className="outer-container">
                    <div className="inner-container">
                        <div className="inner-row one">
                            <div className="box">
                                <p>Q2</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l2")}  onMouseLeave={this.mouseLeave.bind(this)} className="img-1" src={require("../images/gifs/Ethereum-render.gif")}/>
                            </div>
                            <div className="box">
                                <p>Q1</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l1")}  onMouseLeave={this.mouseLeave.bind(this)} className="img-2" src={require("../images/solution-logo.png")}/>
                            </div>
                        </div>
                        ...
                        <div className="inner-row two">
                            <div className="box">
                                <p>Q4</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l4")}  onMouseLeave={this.mouseLeave.bind(this)} className="img-3" src={require("../images/gifs/Key-render-gif.gif")}/>
                            </div>
                            <div className="box">
                                <p>Q3</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l3")} onMouseLeave={this.mouseLeave.bind(this)} className="img-4" src={require("../images/gifs/Reward-logo-Gif.gif")}/>
                            </div>
                        </div>
                        <hr className="hr2"/>
                        <div className="inner-row three">
                            <div className="box">
                                <p>Q7</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l7")} onMouseLeave={this.mouseLeave.bind(this)}  className="img-5" src={require("../images/gifs/Gaming-logo-gif.gif")}/>
                            </div>
                            <div className="box">
                                <p>Q6</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l6")}  onMouseLeave={this.mouseLeave.bind(this)} className="img-6" src={require("../images/gifs/Water-Logo-gif.gif")}/>
                            </div>
                            <div className="box">
                                <p>Q5</p>
                                <img onMouseEnter={this.mouseEnter.bind(this, "l5")} onMouseLeave={this.mouseLeave.bind(this)}  className="img-7" src={require("../images/gifs/Heart-Logo-gif.gif")}/>
                            </div>
                        </div>
